  ...
  return (
    <>
      <MasterPageHeader
        ...
        rightActions={
          <>
            <EmployeeCSVDownload className="halo-button master-action-btn" data={tasks} label="Export Team" />
            <EmployeeCSVDownload className="halo-button master-action-btn" isTemplate label="Download Template" />
            <EmployeeCSVImport className="halo-button master-action-btn" label="Import Team" onImportComplete={() => window.location.reload()} />
