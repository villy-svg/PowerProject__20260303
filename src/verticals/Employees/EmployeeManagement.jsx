  ...
  return (
    <div className="management-view-container">
      <MasterPageHeader
        ...
        onTrayVisibilityChange={ui.handleTrayVisibilityChange}
        hideMenuClose={true}
      ...
      >
        <EmployeeForm
          ...
          initialData={ui.editingItem ? {
            ...
            dob: ui.editingItem.dob ? ui.editingItem.dob.split('T')[0] : '',
            doj: ui.editingItem.hire_date ? ui.editingItem.hire_date.split('T')[0] : '',
